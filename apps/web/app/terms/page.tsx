...
export const metadata: Metadata = {
  ...
  description: "The terms that apply to using ImageConvert.",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-12">
        <Breadcrumb items={[{ label: "ImageConvert", href: "/" }, { label: "Terms of Service" }]} />
        ...
        <div className="text-ink-muted mt-6 flex flex-col gap-4 text-sm leading-relaxed">
          ...
          <p>
            ImageConvert is provided free of charge for converting and compressing images you
          ...
          <p>
            To the fullest extent permitted by law, ImageConvert is not liable for any indirect,
